...
contract DeployProxyAdmin is BaseCreate2Script {
    ...
    function deploy() internal {
        deployProxyAdmin(vm.envAddress("INITIAL_PROXY_ADMIN_OWNER"));
    }

    function deployProxyAdmin(address initialAdmin) internal {
        ...
        console2.log("ProxyAdmin deployed at", address(timelock));
    }
}
